...
export default function Dashboard() {
  ...
  useEffect(() => {
    async function fetchStats() {
      const [books, submissions, pending, subscribers] = await Promise.all([
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-sm text-gray-500">Add, edit or remove books from the catalogue.</p>
          </Link>
          <Link
          ...
          >
            ...
            <p className="text-sm text-gray-500">Read manuscripts and update their status.</p>
          </Link>
          <Link
            to="/admin/newsletter"
            className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow"
          >
            ...
            <p className="text-sm text-gray-500">View and export subscriber email list.</p>
          </Link>
        </div>
      </div>
    </div>
